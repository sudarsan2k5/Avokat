      ...
      <div className="bg-slate-800 py-20">
        ...
        <div className="container mx-auto px-4 pt-20">
          ...
          <p className="text-white/80 text-center mt-4 max-w-2xl mx-auto">
            Login or register to access your account and manage your legal services.
          </p>
        </div>
      </div>

      <div className="py-16 px-4 container mx-auto">
        <Suspense fallback={<div className="flex justify-center"><div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-red-500"></div></div>}>
          <LoginForm />
        </Suspense>
      </div>
